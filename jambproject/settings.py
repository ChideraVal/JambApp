"""
Django settings for jambproject project.
...
WSGI_APPLICATION = 'jambproject.wsgi.application'
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = f'Mune <{str(django_email_host_user)}>'
